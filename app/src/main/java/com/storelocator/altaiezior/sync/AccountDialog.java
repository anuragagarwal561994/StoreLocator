...
import com.storelocator.altaiezior.SearchProduct;
import com.storelocator.altaiezior.R;
...
public class AccountDialog extends DialogFragment {
    ...
    public void accountSelected(Account account) {
        if (account != null) {
            ...
            new GetTokenTask((SearchProduct) getActivity(), account.name, SyncHelper.SCOPE).execute();
        }
    }
}